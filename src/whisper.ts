...
const modelPathOrName = (mn: string, mp: string) => {
  if (mn && mp) throw "Submit a modelName OR a modelPath. NOT BOTH!";
    ...
    console.log("[whisper-node-ts] No 'modelName' or 'modelPath' provided. Trying default model:", DEFAULT_MODEL, "\n");
    ...
    if (!existsSync(modelPath)) {
      ...
      throw `'${DEFAULT_MODEL}' not downloaded! Run 'npx whisper-node-ts download'\n`;
    }
